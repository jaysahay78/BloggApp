    ...
    <div className="container">
      ...
      <p className="section-description mt-5">
        ...
        {pricingTiers.map(({title, monthlyPrice, buttonText, popular, inverse, features}, index) => (
          <div key={title} className={twMerge("card transition-all duration-700 hover:scale-110",inverse===true && 'border-black bg-black text-white' )}>
            ...
            <button onClick={handleClick} className={twMerge("btn btn-primary w-full mt-[30px]", inverse===true && 'bg-white text-black')}>{buttonText}</button>
